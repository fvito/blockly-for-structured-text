...
;(function ($, window, document, undefined) {
	...
	var Tree = function (element, options) {
		...
		return {
			...
			updateTree: $.proxy(this.updateTree, this),
	...
	*/
    ...
    Tree.prototype.updateTree = function (tree) {

        // initialize new state and render changes
		//this._tree[0].nodes = tree[0].nodes;
		console.log(tree);
        console.log(this._tree);
        //let nodeCount = this._tree[0].nodes.length;
        //this._tree[0].nodes.splice(0,nodeCount, tree[0].nodes);
        this._setInitialStates({nodes: this._tree}, 0)
            .done(this._render.bind(this));
    };
