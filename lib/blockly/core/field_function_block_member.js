 ...
 * @constructor
 */
Blockly.FieldFunctionBlockMember = function(varname, opt_validator, opt_variableTypes,
                                      opt_defaultType) {
 ...
 * @package
 */
Blockly.FieldFunctionBlockMember.prototype.initModel = function() {
    if (this.variable_) {
 ...
 * @package
 */
Blockly.FieldFunctionBlockMember.prototype.getVariable = function() {
 ...
 *     variable.
 */
Blockly.FieldFunctionBlockMember.prototype.setValue = function(id) {
 ...
 * @private
 */
Blockly.FieldFunctionBlockMember.prototype.typeIsAllowed_ = function(type) {
 ...
 * @private
 */
Blockly.FieldFunctionBlockMember.prototype.getVariableTypes_ = function() {
 ...
 * @private
 */
Blockly.FieldFunctionBlockMember.prototype.setTypes_ = function(opt_variableTypes,
                                                          opt_defaultType) {
    ...
    if (opt_variableTypes == null || opt_variableTypes == undefined) {
        ...
        if (!isInArray) {
            throw new Error('Invalid default type \'' + defaultType + '\' in ' +
                'the definition of a FieldFunctionBlockMember');
        }
    } else {
        throw new Error('\'variableTypes\' was not an array in the definition of ' +
            'a FieldFunctionBlockMember');
    }
...
Blockly.FieldFunctionBlockMember.dropdownCreate = function() {
    ...
    if (workspace) {
        ...
        //    functionBlocksList.push(functionBlocks[i][3]);
        //}
        functionBlocksList = functionBlocks[0][3];
    }
    ...
    for (var i = 0; i < functionBlocksList.length; i++) {
        ...
        options[i] = [functionBlocksList[i].name, functionBlocksList[i].name];
    }
