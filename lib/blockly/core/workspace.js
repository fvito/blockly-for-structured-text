 ...
 */
Blockly.Workspace.prototype.createVariable = function(name, opt_type, opt_init, opt_address, opt_id) {
  return this.variableMap_.createVariable(name, opt_type, opt_init, opt_address, opt_id);
};

Blockly.Workspace.prototype.changeVariable = function(id, name, type, opt_value, opt_address){
  return this.variableMap_.editVariable(id, name, type, opt_value, opt_address);
};

Blockly.Workspace.prototype.changeVariableType = function(id, new_type){
  return this.variableMap_.changeVariableType(id, new_type);
};
...
/**
 * Find the variable by name, looks through all of the types. Return null if it is not found.
 * @param {!string} name The name to check for
 * @returns {Blockly.VariableModel} the variable with the given name
 */
Blockly.Workspace.prototype.getVariableByName = function(name){
  return this.variableMap_.getVariableByName(name);
};
