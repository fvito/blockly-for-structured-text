 ...
 * @param {string=} opt_init The value to initialize the variable with.
 *      This will default to '' to use the build in type default value.
 * @param {string=} opt_id The unique ID of the variable. This will default to
 *     a UUID.
 * @see {Blockly.FieldVariable}
 * @constructor
 */
Blockly.VariableModel = function(workspace, name, opt_type, opt_init, opt_address, opt_id) {
  /**
