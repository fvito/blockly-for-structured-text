...
goog.provide('Blockly.FieldFunctionBlock');
 ...
 * @constructor
 */
Blockly.FieldFunctionBlock = function(varname, opt_validator, opt_variableTypes,
                                 opt_defaultType) {
    ...
    this.menuGenerator_ = Blockly.FieldFunctionBlock.dropdownCreate;
...
goog.inherits(Blockly.FieldFunctionBlock, Blockly.FieldDropdown);

/**
 * Construct a FieldFunctionBlock from a JSON arg object,
 * dereferencing any string table references.
 * @param {!Object} options A JSON object with options (variable,
 *                          variableTypes, and defaultType).
 * @returns {!Blockly.FieldFunctionBlock} The new field instance.
 * @package
 * @nocollapse
 */
Blockly.FieldFunctionBlock.fromJson = function(options) {
    var varname = Blockly.utils.replaceMessageReferences(options['variable']);
    var variableTypes = options['variableTypes'];
    var defaultType = options['defaultType'];
    return new Blockly.FieldFunctionBlock(varname, null, variableTypes, defaultType);
};
 ...
 * @public
 */
Blockly.FieldFunctionBlock.prototype.init = function() {
    if (this.fieldGroup_) {
        // Dropdown has already been initialized once.
        return;
    }
    Blockly.FieldFunctionBlock.superClass_.init.call(this);
 ...
 * @package
 */
Blockly.FieldFunctionBlock.prototype.initModel = function() {
    if (this.variable_) {
 ...
 * @public
 */
Blockly.FieldFunctionBlock.prototype.dispose = function() {
    Blockly.FieldFunctionBlock.superClass_.dispose.call(this);
 ...
 */
Blockly.FieldFunctionBlock.prototype.setSourceBlock = function(block) {
    goog.asserts.assert(!block.isShadow(),
        'Variable fields are not allowed to exist on shadow blocks.');
    Blockly.FieldFunctionBlock.superClass_.setSourceBlock.call(this, block);
};
 ...
 */
Blockly.FieldFunctionBlock.prototype.getValue = function() {
 ...
 */
Blockly.FieldFunctionBlock.prototype.getText = function() {
 ...
 * @package
 */
Blockly.FieldFunctionBlock.prototype.getVariable = function() {
 ...
 *     variable.
 */
Blockly.FieldFunctionBlock.prototype.setValue = function(id) {
 ...
 * @private
 */
Blockly.FieldFunctionBlock.prototype.typeIsAllowed_ = function(type) {
 ...
 * @private
 */
Blockly.FieldFunctionBlock.prototype.getVariableTypes_ = function() {
 ...
 * @private
 */
Blockly.FieldFunctionBlock.prototype.setTypes_ = function(opt_variableTypes,
                                                     opt_defaultType) {
 ...
 * @this {Blockly.FieldFunctionBlock}
 */
Blockly.FieldFunctionBlock.dropdownCreate = function() {
    if (!this.variable_) {
 ...
 */
Blockly.FieldFunctionBlock.prototype.onItemSelected = function(menu, menuItem) {
 ...
 * @override
 */
Blockly.FieldFunctionBlock.prototype.referencesVariables = function() {
    return true;
};

Blockly.Field.register('field_function_block', Blockly.FieldFunctionBlock);
