...
Blockly.Variables.flyoutCategory = function (workspace) {
    ...
    var editButton = goog.dom.createDom('button');
    editButton.setAttribute('text', "Edit variable");
    editButton.setAttribute('callbackKey', 'EDIT_VARIABLE');

    workspace.registerButtonCallback('EDIT_VARIABLE', function (button) {
       $('#editVariableDialog').modal('show');
    });


    xmlList.push(button);
    xmlList.push(editButton);
...
Blockly.Variables.createVariable_ = function (workspace, id, opt_name,
    ...
    if (potentialVariableMap) {
        ...
        var variable = workspace.createVariable(opt_name, opt_type, opt_init, '', id);
    }
    return variable;
};
