...
Blockly.WorkspaceSvg = function(options, opt_blockDragSurface, opt_wsDragSurface) {
  ...
  if(Blockly.FunctionBlocks && Blockly.FunctionBlocks.flyoutCategory){
    this.registerToolboxCategoryCallback('FUNCTION_BLOCK', Blockly.FunctionBlocks.flyoutCategory);
  }
};
 ...
 * @package
 */
Blockly.WorkspaceSvg.prototype.createVariable = function(name, opt_type, opt_init, opt_address, opt_id) {
  var newVar = Blockly.WorkspaceSvg.superClass_.createVariable.call(
      this, name, opt_type, opt_init, opt_address, opt_id);
  this.refreshToolboxSelection();
  return newVar;
};
